...
import 'package:skybot/controller/video_manager.dart';
import 'package:skybot/widget/cache_image_widget.dart';
import 'package:skybot/widget/video_controls.dart';
...
class VidwoPlayWidgetState extends State<VidwoPlayWidget> with RouteAware {
  ...
  _init() async {
    if (!TextUtil.isEmpty(widget.path)) {
      _videoPlayerController =
          VideoManager.getVideoController(widget.path, cacheId: widget.cacheId);
  ...
  Widget build(BuildContext context) {
    print(
        'isInitialized = ${chewieController?.videoPlayerController.value.isInitialized} ${widget.path}');
    return Container(
  ...
  _buildCover() {
    return CacheImageWidget(
      weightWidth: double.infinity,
      url: widget.videoCover!,
      weightHeight: double.infinity,
    );
  }
