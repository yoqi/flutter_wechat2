...
class KeyboardItem extends StatefulWidget {
  ...
  const KeyboardItem(
      {Key? key, required this.callback, this.text, this.keyHeight})
      : super(key: key);
    ...
    return TapWidget(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: (widget.text == '.' || widget.text == 'del')
                ? Colours.c_f0f0f0
                : Colours.white,
            border: Border(
              bottom: BorderSide(color: Colours.c_EEEEEE, width: 1.w),
              right: BorderSide(color: Colours.c_EEEEEE, width: 1.w),
            )),
