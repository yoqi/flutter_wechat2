...
class _ScaleSizeVideoWidgetState extends State<ScaleSizeVideoWidget>
  ...
  _initVideo() async {
    _videoPlayerController =
        VideoManager.getVideoController(widget.videoUrl, cacheId: cacheId);
  ...
  Widget build(BuildContext context) {
    ...
    if (_videoPlayerController.value.isInitialized) {
      return TapWidget(
        onTap: () async {
          await NavigatorUtils.toNamed(VideoPerviewPage.routeName,
      ...
      return CacheImageWidget(
        url: widget.photoUrl,
        weightWidth: _photoWidth,
        weightHeight: _photoHeight,
        hero: true,
        clipRRect: false,
      );
    }
