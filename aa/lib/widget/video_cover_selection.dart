                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          border: Border.all(
                              ...
                              width: widget
                                  .controller.coverStyle.selectedBorderWidth)),
                      child: Opacity(
                        opacity: 0.5,
                                  ...
                                  builder:
                                    ...
                                    return InkWell(
                                        ...
                                        child: Image(
                                          ...
                                          height: itemHeight,
                                          image:
                                              MemoryImage(coverData.thumbData!),
                                          fit: BoxFit.cover,
                                        ));
                                  });
                            }),
                    ...
                    Positioned(
                      ...
                      child: GestureDetector(
                        child: Container(
                          decoration: BoxDecoration(
                              border: Border.all(
                                  ...
                                  width: widget.controller.coverStyle
                                      .selectedBorderWidth)),
                          width: itemWidth,
                          height: itemHeight,
                        ...
                        onHorizontalDragUpdate: (DragUpdateDetails details) {
                          ...
                          final double scale =
                              ((data.length - 1) * itemWidth - dragWidth) /
                                  dragWidth;
                          ...
                          final double currentIndex =
                              left / (dragWidth / data.length);
                          debugPrint(
                              ' ${1.0.sw} left = $left currentIndex ${scale} ${data.length} $currentIndex');

                          final CoverData coverData =
                              data[currentIndex.toInt()];
                          setState(() {
