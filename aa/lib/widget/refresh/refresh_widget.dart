...
import 'package:skybot/widget/refresh/refresh_footer.dart';
import 'package:skybot/widget/refresh/refresh_header.dart';

typedef RefreshListener = Future<bool> Function(
    pull_to_refresh.RefreshController? controller);
...
class _RefreshWidgetState extends State<RefreshWidget> {
  ...
  Widget build(BuildContext context) {
    return pull_to_refresh.SmartRefresher(
      ...
      footer: widget.loadFooter ??
          pull_to_refresh.CustomFooter(
            builder: (BuildContext context, pull_to_refresh.LoadStatus? mode) {
              return widget.footerBuild != null
                  ? widget.footerBuild!(mode)
                  : RefreshFooter(
                      status: mode,
                    );
            },
          ),
      header: widget.loadHeader ??
          pull_to_refresh.CustomHeader(
            builder:
                (BuildContext context, pull_to_refresh.RefreshStatus? mode) {
