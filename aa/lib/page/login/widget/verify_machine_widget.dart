...
import 'package:skybot/page/login/widget/verify_machine_painter.dart';
import 'dart:ui' as ui;
import 'package:skybot/page/login/widget/verify_machine_slide_widget.dart';
...
class _VerifyMachineWidgetState extends State<VerifyMachineWidget>
    with SubscriptionMixin {
  ui.Image? _image;
  double slideRatio = 0;
  double startRatio = 0.7;
  ...
  Future<ui.Image> load() async {
    ByteData data =
        await rootBundle.load(Utils.getImgPath('verify_machine', dir: 'bg'));
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          if (!_checkError)
            Text(
              Ids.drag_the_lower_slider_to_complete_the_puzzle.str(),
            ...
            ShakeWidget(
                ...
                autoShake: true,
                child: Text(
                  Ids.check_machine_error.str(),
                  style: TextStyle(color: Colours.c_E73E24, fontSize: 32.sp),
                )),
          20.sizedBoxH,
          CustomPaint(
          ...
          20.sizedBoxH,
          Text(
            Ids.control_jigsaw_sliders.str(),
            style: TextStyle(color: Colours.c_FF4E32, fontSize: 32.sp),
          ),
        ],
      ),
    );
