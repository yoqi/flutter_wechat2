...
class VerifyMachineSlideWidget extends StatefulWidget {
  ...
  VerifyMachineSlideWidget(this.slideChange, this.checkChange, {Key? key})
      : super(key: key);

  @override
  State<VerifyMachineSlideWidget> createState() =>
      _VerifyMachineSlideWidgetState();
}
    ...
    return Stack(
      ...
      children: [
        Center(
          ...
          height: 30.w,
          decoration: Colours.c_CCCCCC.boxDecoration(borderRadius: 12.w),
        )),
        Align(
          alignment: Alignment.centerLeft,
