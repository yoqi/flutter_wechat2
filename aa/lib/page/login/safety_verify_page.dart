      ...
      child: Column(
        ...
        children: [
          Icon(
            Icons.info,
            size: 100.w,
            color: Colours.c_4486F4,
          ),
          40.sizedBoxH,
          Text(
            Ids.safety_verify.str(),
            style: TextStyle(
          ...
          20.sizedBoxH,
          Text(
            Ids.register_safety_verify.str(),
            style: TextStyle(color: Colours.c_212129, fontSize: 32.sp),
          ),
          const Spacer(),
          CommonBtn(
            text: Ids.start.str(),
            ...
            onTap: () async {
              var result =
                  await NavigatorUtils.toNamed(VerifyMachinePage.routeName);
              if (result != null) {
