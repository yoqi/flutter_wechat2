...
class ZoneCodePage extends BaseGetBuilder<ZoneCodeController> {
  ...
  Widget controllerBuilder(
      BuildContext context, ZoneCodeController controller) {
    return MyScaffold(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      decoration:
                          Colours.c_EEEEEE.boxDecoration(borderRadius: 6.w),
                      padding:
                          EdgeInsets.symmetric(horizontal: 5.w, vertical: 5.w),
                      child: Text(
                        zoneCode.tel ?? '',
                        style:
                            TextStyle(color: Colours.c_666666, fontSize: 28.sp),
                      ),
                    )
                  ],
                ),
