...
class UniappUtilPage extends BaseGetBuilder<UniappUtilController> {
  ...
  Widget controllerBuilder(
      BuildContext context, UniappUtilController controller) {
    return MyScaffold(
      ...
      actions: [
        CommonBtn(
          ...
          enable: controller.wgtFile != null &&
              controller.avatarFile != null &&
              controller.appIdController.text.trim().isNotEmpty &&
              controller.appNameController.text.trim().isNotEmpty,
        )
      ],
    );
  }
