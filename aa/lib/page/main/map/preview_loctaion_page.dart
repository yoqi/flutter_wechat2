                  ...
                  ? BMFTextureMapWidget(
                      onBMFMapCreated: (_controller) {
                        ...
                        controller.addMarker(
                            ...
                            icon: Utils.getIconImgPath('icon_slider_location'));
                      },
                      mapOptions:
                          controller.initMapOptions(center: _coordinate),
                    )
                  : BMFMapWidget(
                      onBMFMapCreated: (_controller) {
                        controller.onBMFMapCreated(_controller);
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                TapWidget(
                    onTap: () {
                      MapUtil.showDirections(
                          _coordinate.longitude, _coordinate.latitude);
                    },
                    child: Image.asset(
                      Utils.getImgPath('ic_navigation', dir: Utils.DIR_ICON),
                      width: 80.w,
                      height: 80.w,
                    ))
              ],
