...
class SelectLocationPage extends BaseGetBuilder<SelectLocationController> {
  ...
  Widget controllerBuilder(
      BuildContext context, SelectLocationController controller) {
    return Scaffold(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  poi.name ?? '',
                                  style: TextStyle(
                                      color: Colours.black, fontSize: 32.sp),
                                ),
                                if (poi == controller.selectPoi)
                                  Image.asset(
                                    Utils.getImgPath('ic_selected',
                                        dir: Utils.DIR_ICON),
                                    width: 40.w,
                                    height: 40.w,
                                  )
  ...
  Widget buildSlideTransition(
    ...
    return Center(
      ...
      child: SlideTransition(
        ...
        child: Image.asset(
          Utils.getIconImgPath('icon_slider_location'),
          width: 80.w,
          height: 80.w,
        ),
      ),
