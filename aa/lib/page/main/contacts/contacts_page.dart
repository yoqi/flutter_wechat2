...
class ContactsPage extends BaseGetBuilder<FriendController> {
  ...
  Widget controllerBuilder(BuildContext context, FriendController controller) {
    return MainScaffold(Ids.contacts.str(), _buildBody(controller));
  }
          ...
          () => RemoveTopPaddingWidget(
            ...
            itemBuilder: (context, index) {
              ...
              return AutoScrollTag(
                  ...
                  child: FriendItem(
                    friend: controller.friends[index - 1],
                    lastFriend: controller.friends.safetyItem(index - 2),
                  ));
            },
          ...
          children: [
            ClipRectWidget(
              ...
              Utils.getImgPath(icon,
                  dir: Utils.DIR_CONTACT, format: Utils.WEBP),
              width: 80.w,
              height: 80.w,
            )),
            40.sizedBoxW,
