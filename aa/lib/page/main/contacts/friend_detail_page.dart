...
class FriendDetailPage extends BaseGetBuilder<FriendDetailController> {
  ...
  Widget controllerBuilder(
      BuildContext context, FriendDetailController controller) {
    return MyScaffold(
          ...
          children: [
            Container(
              ...
              child: Row(
                ...
                children: [
                  AvatarWidget(
                    avatar: controller.friend?.avatar,
                    weightWidth: 150.w,
                  ),
                  20.sizedBoxW,
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          controller.friend?.nickname ?? 'name',
                          style:
                              TextStyle(color: Colours.black, fontSize: 48.sp),
                        ),
                        10.sizedBoxH,
                        Row(
                          children: [
                            Text(
                              'WeChat ID:',
                              style: TextStyle(
                                  color: Colours.black, fontSize: 24.sp),
                            ),
                            Expanded(
                                child: Text(
            ...
            else if (controller.friend?.username !=
                ...
                itemBuilder: (context, index) {
                  return Container(
                      ...
                      child: CacheImageWidget(
                          url: controller.friendCircles[index],
                          weightWidth: 100.w,
                          weightHeight: 100.w));
                },
                scrollDirection: Axis.horizontal,
                itemCount: controller.friendCircles.length,
              ),
            ),
          )
        ],
    ...
    return TapWidget(
      onTap: () {
        ChatManagerController.instance
            .createSingleChat(controller.friend?.username ?? '');
      },
      child: Container(
        height: 100.w,
        color: Colours.white,
