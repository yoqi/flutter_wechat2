      ...
      onTap: () {
        if (onTap != null) {
          ...
          NavigatorUtils.toNamed(FriendDetailPage.routeName,
              arguments: friend['followee']['username']);
        }
      },
      child: Column(
        children: [
              ...
              children: [
                if (selectType != null)
                  Container(
                      ...
                      child: Opacity(
                          opacity: selectType == -1 ? 0.5 : 1,
                          child: Image.asset(
                            Utils.getIconImgPath(selectType == 0
                                ? 'icon_no_select'
                                : 'icon_selected'),
                            width: 40.w,
                            height: 40.w,
                ...
                AvatarWidget(
                  avatar: friend['followee']['avatar'],
                  weightWidth: 80.w,
                ),
                20.sizedBoxW,
                Expanded(
                  child: Text(
                    friend['followee']['nickname'] ?? 'name',
