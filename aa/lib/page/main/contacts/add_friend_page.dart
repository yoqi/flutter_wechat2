    ...
    return Column(
      children: [
        TapWidget(
          onTap: () async {
            var result =
                await NavigatorUtils.toNamed(SearchFriendPage.routeName);
            if (result ?? false) {
              NavigatorUtils.pop();
            }
          },
          child: Container(
            ...
            child: Row(
              ...
              children: [
                Image.asset(
                  Utils.getImgPath('search_white', dir: Utils.DIR_ICON),
        ...
        Row(
          ...
          children: [
            Text(
              '${Ids.accound_and_phone.str()} ${UserController.instance.user?.wxId}',
