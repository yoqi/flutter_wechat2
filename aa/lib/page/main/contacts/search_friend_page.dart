  ...
  _buildBody(BuildContext context, SearchFriendController controller) {
    return Container(
      padding: EdgeInsets.only(
          top: context.statusHeight + 20.w, left: 20.w, right: 20.w),
      child: Column(
        children: [
          Row(
            children: [
              ...
              TapWidget(
                  child: Text(
                    Ids.cancel.str(),
                    style: TextStyle(color: Colours.c_4486F4, fontSize: 32.sp),
                  ),
                  onTap: () {
                    NavigatorUtils.pop();
                  })
    ...
    return TapWidget(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Image.asset(
              Utils.getImgPath('ic_search_friend', dir: Utils.DIR_CONTACT),
              width: 100.w,
              height: 100.w,
            ),
            20.sizedBoxW,
            ...
            Text(
              controller.controller.text.toString(),
              style: TextStyle(color: Colours.theme_color, fontSize: 32.sp),
            ),
          ],
        ),
      ),
