...
import 'package:skybot/page/main/discover/widget/friend_circle_item.dart';
...
class FriendCirclePage extends BaseGetBuilder<FriendCircleController> {
  ...
  Widget controllerBuilder(
      BuildContext context, FriendCircleController controller) {
    return MyScaffold(
      showAppbar: false,
        ...
        return Container(
          ...
          child: Row(
            ...
            children: [
              ...
              TapWidget(
                onTap: () async {
                  var create = await NavigatorUtils.toNamed(
                      CreateFriendCirclePage.routeName);
                  if (create ?? false) {
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          TapWidget(
            onTap: () async {
              var file = await DialogUtil.choosePhotoDialog(context,
                  crop: true, aspectRatio: 1.25);
              if (file != null) {
