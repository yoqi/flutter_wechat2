...
import 'package:skybot/widget/lottie_widget.dart';
...
class _ShakePageState extends State<ShakePage>
    with SingleTickerProviderStateMixin, SubscriptionMixin {
      ...
      child: Container(
        ...
        child: Container(
          ...
          child: Align(
            ...
            child: Image.asset(
              Utils.getImgPath('icon_shake_top', dir: Utils.dir_discover),
              fit: BoxFit.cover,
              width: 256.w,
              height: 128.w,
            ),
      ...
      child: Container(
        ...
        child: Container(
          ...
          child: Align(
            ...
            child: Image.asset(
              Utils.getImgPath('icon_shake_bottom', dir: Utils.dir_discover),
              fit: BoxFit.cover,
              width: 256.w,
              height: 128.w,
            ),
    ...
    return Center(
      child: Container(
        ...
        child: Column(
          ...
          children: [
            LottieWidget(
              assetPath: Utils.getLottiePath('heartbeat'),
              height: 200.w,
              width: 200.w,
            ),
            20.sizedBoxH,
