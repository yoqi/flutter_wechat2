...
class _ChannelsVideoEditPageState extends State<ChannelsVideoEditPage> {
  ...
  _initController() {
    _controller = VideoEditorController.file(_video,
        maxDuration: const Duration(seconds: 30),
        trimStyle: TrimSliderStyle(lineWidth: 5.w, lineColor: Colours.white));
  ...
  _buildBody(BuildContext context) {
    return SizedBox(
      ...
      child: Column(
        children: [_buildVideo(), _buildTrimSlider(), _buildBottomBar()],
      ),
    );
  }
      ...
      child: Row(
        ...
        children: [
          CommonBtn(
              ...
              onTap: () async {
                if (_controller.startTrim == Duration.zero &&
                    _controller.endTrim == _controller.video.value.duration) {
