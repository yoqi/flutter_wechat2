...
import 'package:skybot/page/main/chat/controller/chat_controller.dart';
import 'package:skybot/page/main/chat/widget/chat_input_widget.dart';
import 'package:skybot/page/main/chat/widget/message/message_item.dart';
import 'package:skybot/page/main/chat/widget/record_preview_widget.dart';
import 'package:skybot/utils/navigator_utils.dart';
import 'package:skybot/widget/base_scaffold.dart';
import 'package:scroll_to_index/scroll_to_index.dart';
import 'package:skybot/widget/refresh/refresh_widget.dart';
        ...
        TapWidget(
            onTap: () async {
              if (controller.conversation != null) {
                NavigatorUtils.toNamed(ChatDetailPage.routeName,
                ...
                itemBuilder: (context, index) {
                  return AutoScrollTag(
                      ...
                      child: MessageItem(
                        ...
                        lastMessage: controller.messages.safetyItem(index + 1),
                      ));
                },
