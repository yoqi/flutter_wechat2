...
import 'package:skybot/page/main/chat/widget/chat_item.dart';
import 'package:skybot/page/main/chat/widget/uniapp_panel.dart';
      ...
      builder: (BuildContext context, BoxConstraints constraints) {
        return WillPopScope(
          ...
          child: SlidingUpPanel(
            ...
            minHeight: 160.w,
            onWillPop: false,
            panel: MainScaffold(Ids.wachat.str(), _buildBody(_controller)),
          ),
        );
      },
    );
