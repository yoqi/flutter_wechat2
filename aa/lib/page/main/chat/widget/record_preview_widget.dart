...
import 'package:skybot/page/main/chat/widget/press_record_widget.dart';
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Image.asset(
                Utils.getImgPath(
                    value == PressRecordWidgetState.VOICE_STATUS_END
                        ? "record_power_${_controller.peakPower.value}"
                        : "record_cancel",
                    dir: Utils.DIR_CHAT),
                width: 150.w,
                height: 150.w,
              ...
              Text(
                value == PressRecordWidgetState.VOICE_STATUS_END
                    ? Ids.up_for_cancel.str()
                    : Ids.loosen_to_cancle.str(),
