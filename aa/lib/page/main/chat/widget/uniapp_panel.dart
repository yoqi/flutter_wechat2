...
import 'package:skybot/page/main/chat/controller/uniapp_controller.dart';
...
import 'package:skybot/widget/sliding_up_panel.dart';
  ...
  Widget controllerBuilder(BuildContext context, UniappController controller) {
    return Container(
      ...
      child: Column(
        children: [
          Text(
            Ids.recently_used_mini_program.str(),
            style: TextStyle(color: Colours.c_EEEEEE, fontSize: 32.sp),
          ),
          20.sizedBoxH,
          Expanded(
            child: Obx(
                  ...
                  return TapWidget(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        10.sizedBoxH,
                        Text(
                          controller.list[index]['appName'],
                          style:
                              TextStyle(color: Colours.white, fontSize: 32.sp),
                        )
                      ],
                    ),
                  );
