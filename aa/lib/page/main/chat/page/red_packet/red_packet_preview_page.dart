...
import 'package:skybot/page/main/chat/page/red_packet/controller/red_packet_controller.dart';
import 'package:skybot/page/main/chat/page/red_packet/widget/red_packet_painter.dart';
          ...
          children: [
            ...
            Align(
              ...
              child: Container(
                ...
                decoration:
                    Colours.c_FA9E3B.borderDecoration(borderRadius: 50.w),
      ...
      builder: (context, child) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              _message.text ?? '',
              style: TextStyle(fontSize: 28.sp, color: const Color(0xFFF8E7CB)),
            )
          ],
        ),
      ),
