...
import 'package:skybot/page/main/chat/page/red_packet/widget/red_packet_top_bg.dart';
...
class RedPacketDetailPage extends BaseGetBuilder<RedPacketDetailController> {
  ...
  Widget controllerBuilder(
      BuildContext context, RedPacketDetailController controller) {
    return MyScaffold(
      showAppbar: false,
        ...
        children: [
          Row(
            ...
            children: [
              ...
              10.sizedBoxW,
              Text(
                "${MemberController.instance.getMember(_message.fromClientID)?.nickname}的红包",
                style: TextStyle(
                    fontSize: 32.sp,
                    color: Colours.black,
              ...
              Container(
                ...
                child: Center(
                  child: Text(
                    '拼',
                    style: TextStyle(
                        color: Colours.white, fontSize: 24.sp, height: 1.1),
                  ),
                ),
              )
            ],
          ...
          Text(
            _message.text ?? '',
            style: TextStyle(fontSize: 28.sp, color: Colours.c_CCCCCC),
          ),
          40.sizedBoxH,
            ...
            Row(
              ...
              children: [
                SizedBox(
                    height: 80.sp,
                    child: Text(
                      '${controller.redPacket!['amount']}',
                      textAlign: TextAlign.center,
                      style: TextStyle(
                          fontSize: 96.sp, color: Colours.c_D48610, height: 1),
                    )),
                Text(
                  '元',
                  style: TextStyle(
                      fontSize: 32.sp, color: Colours.c_D48610, height: 1.0),
                ),
              ],
            ),
          100.sizedBoxH,
          ...
          Container(
            ...
            child: (controller.redPacket != null)
                ? Align(
                    ...
                    child: Text(
                        '${controller.redPacket!['packet_count']}个红包共${controller.redPacket!['amount']}元，3秒被抢光',
                        style: TextStyle(
                            fontSize: 28.sp, color: Colours.c_CCCCCC)))
                : null,
          ),
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        "${MemberController.instance.getMember(_message.fromClientID)?.nickname}",
                        style: TextStyle(fontSize: 32.sp, color: Colours.black),
                      ),
                      Text(
                        "8月2日 19:35",
                        style:
                            TextStyle(fontSize: 24.sp, color: Colours.c_CCCCCC),
                      ),
                    ],
                  ),
                ),
                if ((controller.redPacket != null))
                  Column(
                    ...
                    children: [
                      Text(
                        '${controller.redPacket!['amount']}元',
                        style: TextStyle(
                            fontSize: 32.sp, color: Colours.black, height: 1),
                      ),
                      5.sizedBoxH,
                      Row(
                        mainAxisSize: MainAxisSize.min,
