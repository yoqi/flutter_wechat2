...
import 'package:skybot/page/main/contacts/contacts_page.dart';
import 'package:skybot/page/main/discover/discover_page.dart';
import 'package:skybot/widget/base_scaffold.dart';
import 'package:skybot/widget/lazy_indexed_stack.dart';
    ...
    if (payload != null) {
      if (payload.startsWith('chatId:')) {
        NavigatorUtils.offNamedUntil(ChatPage.routeName, MainPage.routeName,
            arguments: payload.replaceAll('chatId:', ''));
      }
    }
  }
