...
import 'package:skybot/utils/language_util_v2.dart';
...
class _LanguageSettingPageState extends State<LanguageSettingPage> {
  ...
  Widget build(BuildContext context) {
    return MyScaffold(
      ...
      body: Column(
        children: LanguageUtilV2.getLanguages()
            .map((e) => _buildLanguageItem(e))
            .toList(),
      ),
      actions: [
        CommonBtn(
  ...
  Widget _buildLanguageItem(LanguageModel model) {
    return TapWidget(
      ...
      child: Container(
        ...
        decoration: Colours.c_CCCCCC.bottomBorder(bgColor: Colours.white),
        child: Row(
          ...
          children: [
            ...
            if (model == _selectLanguage)
              Image.asset(
                Utils.getIconImgPath('ic_selected'),
                width: 40.w,
                height: 40.w,
              )
          ],
