  ...
  _buildHeader() {
    return TapWidget(
      ...
      child: Container(
        color: Colours.white,
        padding:
            EdgeInsets.only(top: 200.w, left: 40.w, right: 40.w, bottom: 40.w),
        child: Row(
          children: [
            TapWidget(
                onTap: () {
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    UserController.instance.user?.wxId ?? 'wxid',
                    style: TextStyle(color: Colours.black, fontSize: 24.sp),
                  ),
                ],
              ),
            ...
            20.sizedBoxW,
            Image.asset(
              Utils.getImgPath('ic_right_arrow_grey',
                  dir: Utils.DIR_ICON, format: Utils.WEBP),
              width: 20.w,
              height: 20.w,
            ),
          ],
