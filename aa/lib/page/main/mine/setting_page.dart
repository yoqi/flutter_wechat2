...
class SettingPage extends StatelessWidget {
  ...
  _buildBody(BuildContext context) {
    return Column(
      children: [
        RightArrowWidget(
          lable: Ids.account_and_safety.str(),
          callback: () {},
        ),
        20.sizedBoxH,
        RightArrowWidget(
          lable: Ids.new_message_notify.str(),
          callback: () {},
        ),
        20.sizedBoxH,
        RightArrowWidget(
        ...
        1.sizedBoxH,
        RightArrowWidget(
          lable: Ids.common.str(),
          callback: () {},
        ),
        1.sizedBoxH,
        RightArrowWidget(
          lable: Ids.friend_permission.str(),
          callback: () {},
        ),
        1.sizedBoxH,
        RightArrowWidget(
          lable: Ids.language.str(),
          callback: () {
        ...
        20.sizedBoxH,
        RightArrowWidget(
          lable: Ids.about_wechat.str(),
          callback: () {},
        ),
        20.sizedBoxH,
        RightArrowWidget(
          lable: Ids.help_and_feedback.str(),
          callback: () {},
        ),
        20.sizedBoxH,
        RightArrowWidget(
          lable: Ids.mini_program_update_util.str(),
          callback: () {
